<div class="card">
    ...
    <div class="card-body">
            ...
            <table class="table table-sm table-bordered table-hover m-0">
                ...
                <tbody>
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        if (!empty($keyword)) {
                            $query = mysqli_query($con, "SELECT * FROM mahasiswa WHERE nim LIKE '%" . $keyword . "%' OR nama LIKE '%" . $keyword . "%'") or die(mysqli_error($con));
                        }
                    }
        ...
        <?php
        $result = mysqli_query($con, "SELECT * FROM mahasiswa") or die(mysqli_error($con));
